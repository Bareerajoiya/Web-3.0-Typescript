...
var personName = "Olivia Ann Rose";
var quote = '"i hope one day u look at me, and see everything you ever you ever wante. a letter to my future self"';
...
var Names = ["Bareera", "Hannan", "Hassan"];
console.log(Names);
...
var Guest = ["Bareera", "Hassan", "Hannan", "Khansa"];
...
var Guest = ["Bareera", "Sundas", "Hannan", "Khansa"];
for (let i = 0; i < Guest.length; i++) {
    if (Guest[i] == "Bareera") {
        console.log(Guest[i], "I would like to invite you to dinner.");
    }
...
var Guest1 = ["Bareera", "Sundas", "Hannan", "Khansa"];
...
var Dinner = ["Hannan", "Zohan", "Bareera"];
var Totpeople = 0;
...
// Write a program that creates a list containing these items.
var Cities = ["Ankara", "Istanbul", "Capadocia", "Lahore", "Islamabad"];
...
var ErrorIndex = ["Bareera", "Joiya", "Khansa", "Happy"];
...
var arr2 = ["Cold Drinks", "Noodles", "Lays", "candies"];
...
var arr3 = ["Cold Drinks", "Noodles", "Lays", "candies"];
...
var favFruits = ["Mango", "Guava", "Orange", "Papaya", "grapes"];
...
var usernames = ["Bareera", "Hannan", "Hassan", "Anam"];
...
var users = ["Bareera", "Hassan", "Hannan", "Zohan"];
...
var current_users = ["Bareera", "Hassan", "Hannan", "Khansa", "Zohan"];
...
var new_users = ["Sundas", "Anam", "Shoaib", "Bareera", "Fakhir", "Hannan"];
...
var pizzas = ["malai boti", " fajita", "behari kabbab"];
...
var magician_names = ["Hannan", "Hassan", "Zohan"];
...
var magicians = ["Hannan", "Hassan", "Zohan"];
